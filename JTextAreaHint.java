...
public class JTextAreaHint extends JTextArea implements FocusListener {
	...
	/**
	 * *INFORMACION
	 * La clase genera un area de texto con dindicador.
	 * Esta implementacion extiende de JTextArea e incorpora
	 ...
	 */
	public JTextAreaHint(Font Font_Lost , Font Font_Gained, Color Color_Lost , Color Color_Gained){
